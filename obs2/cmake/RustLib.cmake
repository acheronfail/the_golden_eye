...
elseif(GE_RUST_PACKAGE_PROFILE)
  set(RUST_PROFILE "dist")
  list(APPEND CARGO_BUILD_FLAGS --profile dist)
else()
...
if(WIN32)
  set(RUST_LIB "${RUST_DIR}/target/${RUST_PROFILE}/ge_runtime.lib")
else()
  set(RUST_LIB "${RUST_DIR}/target/${RUST_PROFILE}/libge_runtime.a")
endif()
...
set(RUST_CARGO_ENV
      ...
      "GE_YOUTUBE_CLIENT_ID=${GE_YOUTUBE_CLIENT_ID}"
      "GE_YOUTUBE_CLIENT_SECRET=${GE_YOUTUBE_CLIENT_SECRET}"
      "GE_YOUTUBE_ENABLED=${GE_YOUTUBE_ENABLED}"
      ${RUST_BUILD_ENV})

set(RUST_CARGO_ENV_FILE "${CMAKE_CURRENT_BINARY_DIR}/rust-cargo-env.sh")
set(RUST_CARGO_ENV_CONTENT
     "# Generated by CMake. Source this before direct cargo commands for ge_runtime.\n")
foreach(_env ${RUST_CARGO_ENV})
  ...
  string(APPEND RUST_CARGO_ENV_CONTENT "export ${_env_name}='${_env_value_quoted}'\n")
endforeach()
file(GENERATE OUTPUT "${RUST_CARGO_ENV_FILE}" CONTENT "${RUST_CARGO_ENV_CONTENT}" NEWLINE_STYLE UNIX)
...
if(GE_REUSE_HOST_BUILD_INPUTS)
  add_custom_target(rust_build ALL
      ...
      COMMAND ${CMAKE_COMMAND}
              "-DGE_REQUIRED_FILE=${CMAKE_CURRENT_SOURCE_DIR}/core/ge_runtime.h"
              -P "${CMAKE_CURRENT_SOURCE_DIR}/cmake/check-file-exists.cmake"
      VERBATIM
  )
else()
