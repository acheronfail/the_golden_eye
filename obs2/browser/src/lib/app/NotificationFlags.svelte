...
{#if notifications.flags.length > 0}
	<div
		class="pointer-events-none fixed bottom-4 left-1/2 z-[100] flex w-[min(28rem,calc(100vw-2rem))] -translate-x-1/2 flex-col items-center gap-2 sm:right-4 sm:left-auto sm:translate-x-0 sm:items-end"
		aria-live="polite"
		aria-atomic="false"
	>
