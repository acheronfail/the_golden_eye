...
>
	...
	>
		...
		<MonitorHero
			...
			detailClass="glass-detail font-mono text-[clamp(0.65rem,2.8cqw,0.82rem)] tracking-[0.15em] text-(--obs-text-dim) uppercase [@container(max-height:42rem)]:text-[clamp(0.58rem,2cqw,0.72rem)]"
			hiddenDetailClass="invisible"
			metricsClass="glass-metrics mt-[clamp(1.5rem,5cqw,2.5rem)] grid grid-cols-3 gap-[clamp(0.7rem,4cqw,2rem)] border-t border-[color-mix(in_srgb,var(--monitor-accent)_25%,var(--obs-border-muted))] pt-[clamp(1.25rem,4cqw,2rem)] font-mono [&_small]:text-[0.65rem] [&_small]:tracking-[0.12em] [&_small]:text-(--obs-text-dim) [&_small]:uppercase [&_strong]:text-[clamp(1.25rem,6cqw,2.6rem)] [&_strong]:font-medium [&_strong]:[font-variant-numeric:tabular-nums] [&>span]:grid [&>span]:min-w-0 [&>span]:gap-[0.2rem] [@container(max-height:42rem)]:mt-[clamp(0.45rem,2cqw,0.7rem)] [@container(max-height:42rem)]:pt-[clamp(0.4rem,2cqw,0.65rem)] [@container(max-height:42rem)]:[&_strong]:text-[clamp(0.75rem,3cqw,1rem)] [@container(max-height:58rem)]:mt-[clamp(0.65rem,2.5cqw,1rem)] [@container(max-height:58rem)]:gap-[clamp(0.5rem,2cqw,1rem)] [@container(max-height:58rem)]:pt-[clamp(0.55rem,2.5cqw,0.9rem)] [@container(max-height:58rem)]:[&_small]:text-[0.55rem] [@container(max-height:58rem)]:[&_strong]:text-[clamp(0.85rem,3.2cqw,1.35rem)]"
