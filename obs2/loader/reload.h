...
// loader/tests/ can exercise it standalone); plugin.c owns all OBS coupling.

#include <stdbool.h>
#include <stddef.h>

// Function pointer the core calls (via ge_core_trigger_reload) to ask the loader
