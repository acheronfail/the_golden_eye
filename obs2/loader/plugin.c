// Thin loader: the library OBS actually loads. No real logic beyond OBS-module
...
// staged before being applied. Rust (update_apply.rs) and this loader agree on
...
bool obs_module_load(void) {
  GE_LOG(LOG_INFO, "loader v%s loading", ge_loader_version());
