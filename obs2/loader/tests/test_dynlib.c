// Drives loader/dynlib.c directly: the raw dlopen/dlsym/dlclose wrapper and
...
int main(int argc, char **argv) {
  ...
  if (g_failures == 0) {
    printf("all loader dynlib tests passed\n");
    return 0;
  }
  fprintf(stderr, "%d loader dynlib test failure(s)\n", g_failures);
  return 1;
}
