...
const GE_MONITOR_TIMING: &str = "GE_MONITOR_TIMING";
const GE_MONITOR_SLOW_MS: &str = "GE_MONITOR_SLOW_MS";
...
impl MonitorTimingMode {
    ...
    pub(crate) fn from_env() -> Self {
        match env_string(GE_MONITOR_TIMING) {
