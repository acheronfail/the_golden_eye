...
| Diagnostic capture and one-shot matching                 | [capture_tools](capture_tools/mod.rs)                                                                                                              |
...
shim retain their existing loading and reload responsibilities. Firmware and frame regression tools
