...
pub(crate) struct CapturedFrameStats {
    pub(crate) capture_ms: Option<f64>,
    pub(crate) callback_interval_ms: Option<f64>,
    pub(crate) capture_timings: Option<crate::obs::GeCaptureTimings>,
    pub(crate) mailbox_wait_ms: Option<f64>,
    pub(crate) dropped_frames_total: u64,
}

#[cfg(test)]
#[path = "frame_capture_test.rs"]
mod capture_test;
...
impl ObsSource {
    pub(crate) fn set_capture_region(&mut self, region: Option<CaptureRegion>) {
    ...
    pub(crate) fn capture_with_stats_until<F, R>(&mut self, deadline: Option<Instant>, use_frame: F) -> Captured<R>
    where
