...
Don't worry though, we can fix this easily, and we only have to do this once (the plugin can still update).
To fix it, you'll need to run the following in Terminal:
