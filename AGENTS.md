...
- `settings_bindings` exports the Rust settings contract before the browser build.
...
- `obs2/settings-contract/` - canonical settings model/defaults and the TypeScript exporter.
